...
export class LoginActions { // class é uma estrutura que define um objeto, e o construtor é um método especial usado para criar e inicializar objetos criados a partir da classe. Ele é chamado automaticamente quando uma nova instância da classe é criada.
    page: Page;
